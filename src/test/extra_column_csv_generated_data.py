...
file_location = "D:\\Data_Engineer\\DE_Projects\\ecome_sparkdata\\sales_data"
...
csv_file_path = os.path.join(file_location, f"sales_data_extra_columns_{input_date_str}.csv")
